...
CYCLE_TESTER = env.int("CYCLE_TESTER", 5)
# definition of getter cycle, it will get proxy every CYCLE_GETTER second
CYCLE_GETTER = env.int("CYCLE_GETTER", 6*60)
GET_TIMEOUT = env.int("GET_TIMEOUT", 30)

# definition of tester
TEST_URL = env.str("TEST_URL", "https://www.httpbin.org/get")
TEST_TIMEOUT = env.int("TEST_TIMEOUT", 60)
TEST_BATCH = env.int("TEST_BATCH", 100)
